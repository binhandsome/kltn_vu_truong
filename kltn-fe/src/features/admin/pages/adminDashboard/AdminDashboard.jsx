                        ...
                        <div className="card ad-info-card">
                            <div className="card-body dd-flex align-items-center">
                                <div className="icon-info">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.126 512.126" >
                    ...
                    <div className="col-xl-12 col-lg-12 col-md-12">
                        <div className="card chart-card">
                            <div className="card-header">
                                <h4 className="has-btn">Total Revanue <span><button type="button" className="btn btn-primary squer-btn sm-btn">Download</button></span></h4>
                            </div>
                                        ...
                                        <div className="revenue-wrapper">
                                            <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                <li className="nav-item">
                                                    <a className="nav-link active" id="tab1-tab" data-bs-toggle="pill" href="index.html#tab1" role="tab" aria-controls="tab1" aria-selected="true">Weekly</a>
                                                </li>
                                                <li className="nav-item">
                                                    <a className="nav-link" id="tab2-tab" data-bs-toggle="pill" href="index.html#tab2" role="tab" aria-controls="tab2" aria-selected="false">Monthly</a>
                                                </li>
                                                <li className="nav-item">
                                                    <a className="nav-link" id="tab3-tab" data-bs-toggle="pill" href="index.html#tab3" role="tab" aria-controls="tab3" aria-selected="false">Yearly</a>
                                                </li>
                                            </ul>
                                                ...
                                                <div className="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                                    <div className="revenue-info-wrap">
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td><i className="far fa-chart-bar mr-2 icon-only"></i>Total Sales</td>
                                                                    <td>5995<sup className="medium ml-2 txt-green">+15%</sup></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i className="fas fa-user-friends mr-2 icon-only"></i>Total Customers</td>
                                                                    <td>5894<sup className="medium ml-2 txt-green">+15%</sup></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i className="fas fa-hand-holding-usd mr-2 icon-only"></i>Total Income</td>
                                                                    <td>4453<sup className="medium ml-2 txt-green">+25%</sup></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i className="fas fa-signal mr-2 icon-only"></i>Total Expense</td>
                                                                    <td>7454<sup className="medium ml-2 txt-red">+2%</sup></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i className="far fa-heart mr-2 icon-only"></i>Total Likes</td>
                                                                    <td>14454<sup className="medium ml-2 txt-red">+5%</sup></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i className="far fa-frown-open mr-2 icon-only"></i>Tax Paid</td>
                                                                    <td>786<sup className="medium ml-2 txt-green">+5%</sup></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
