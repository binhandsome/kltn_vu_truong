                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-primary col-3"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-secondary col-2"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-info col-6"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-success col-8"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-warning col-5"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-dark col-9"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-warning col-10"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                        ...
                        <td>
                          <label
                            className="mb-0 badge badge-secondary"
                            title="Pending"
                          >
                            Pending
                          </label>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-secondary col-3"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="progress">
                            <div
                              className="progress-bar bg-success col-1"
                              role="progressbar"
                              aria-valuenow={25}
                              aria-valuemin={0}
                              aria-valuemax={100}
