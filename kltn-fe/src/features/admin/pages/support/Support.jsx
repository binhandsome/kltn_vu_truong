                    ...
                    <div className="col xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="page-title-wrapper">
                            <div className="page-title-box">
								{/* Support */}
                                <h4 className="page-title">Hỗ trợ</h4>
                            </div>
                            <div className="breadcrumb-list">
                                <ul>
                                    ...
                                    <li className="breadcrumb-link active">Hỗ trợ</li>
                                </ul>
                            </div>
                        </div>
                    </div>
									...
									<div className="card ad-info-card">
										<div className="card-body dd-flex align-items-center">
											...
											<div className="icon-info-text">
												{/* Order Customers */}
												<h5 className="ad-title">Khách hàng đặt hàng</h5>
												<h4 className="ad-card-title">2563</h4>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="col-xl-3 col-lg-4 col-md-6">
									<div className="card ad-info-card">
										<div className="card-body dd-flex align-items-center">
											...
											<div className="icon-info-text">
												{/* Running Orders */}
												<h5 className="ad-title">Đơn hàng đang chạy</h5>
												<h4 className="ad-card-title">2500</h4>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="col-xl-3 col-lg-4 col-md-6">
									<div className="card ad-info-card">
										<div className="card-body dd-flex align-items-center">
											...
											<div className="icon-info-text">
												{/* Pending */}
												<h5 className="ad-title">Chờ xác nhận</h5>
												<h4 className="ad-card-title">2060</h4>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="col-xl-3 col-lg-4 col-md-6">
									<div className="card ad-info-card">
										<div className="card-body dd-flex align-items-center">
											...
											<div className="icon-info-text">
												{/* Done */}
												<h5 className="ad-title">Hoàn thành</h5>
												<h4 className="ad-card-title">5600</h4>
											</div>
										</div>
									</div>
								</div>
