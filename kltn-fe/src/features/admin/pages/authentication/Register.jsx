                        ...
                        <form>
                            ...
                            <div className="ad-auth-form">
								<div className="ad-auth-feilds mb-30">
                                    <input type="text" placeholder="Enter Name" className="ad-input" />
                                    <div className="ad-auth-icon">
                                        <svg 
										 xmlns="http://www.w3.org/2000/svg"
										 width="16px" height="16px">
										<path fillRule="evenodd"  fill="rgb(154, 190, 237)"
                            ...
                            <div className="ad-auth-btn">
                                <a href="javascript:void(0);" className="ad-btn ad-login-member">Sign up</a>
                            </div>
                            <p className="ad-register-text">Already have an account ? <a href="login.html">Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
