                ...
                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div className="ad-auth-content">
                        <form>
                            ...
                            <h2><span className="primary">Hello,</span>Welcome!</h2>
                            <p>Please Enter Your Details Below to Continue</p>
                            <div className="ad-auth-form">
                                <div className="ad-auth-feilds mb-30">
                                    <input type="text" placeholder="Email Address" className="ad-input" />
                            ...
                            <div className="ad-other-feilds">
                                <div className="ad-checkbox">
                                    <label>
									<input type="checkbox" name="remeber" className="ad-checkbox"/>
									<span>Remember Me</span>
									</label>
                                </div>
                                <a className="forgot-pws-btn" href="forgot-pws.html">Forgot Password?</a>
                            </div>
                            <div className="ad-auth-btn">
                                <a href="javascript:void(0);" className="ad-btn ad-login-member">Login</a>
                            </div>
                            <p className="ad-register-text">Don't have an account? <a href="register.html">Click Here</a></p>
                        </form>
                    </div>
                </div>
            </div>
