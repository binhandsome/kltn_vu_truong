                        ...
                        <div className="page-title-wrapper">
                            ...
                            <div className="breadcrumb-list">
                                <ul>
                                    ...
                                    <li className="breadcrumb-link active">Checkout</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="card-body">
                                    <form>
										<div className="row">
											<div className="col-xl-6 col-lg-6">
												<div className="form-group">
													<label for="text-input" className="col-form-label">First Name</label>
													<input className="form-control" type="text" placeholder=""/>
												</div>
											</div>
											<div className="col-xl-6 col-lg-6">
												 <div className="form-group">
													<label for="text-input" className="col-form-label">Last Name</label>
													<input className="form-control" type="text" placeholder=""/>
												</div>
											</div>
										</div>
										<div className="row">
											<div className="col-xl-6 col-lg-6">
												 <div className="form-group">
													<label for="text-input" className="col-form-label">Phone</label>
													<input className="form-control" type="text" placeholder=""/>
												</div>
											</div>
											<div className="col-xl-6 col-lg-6">
												 <div className="form-group">
													<label for="text-input" className="col-form-label">Email Address</label>
													<input className="form-control" type="text" placeholder=""/>
												</div>
											</div>
										</div>
										<div className="row">
											...
											<div className="col-xl-6 col-lg-6">
												<div className="form-group">
													<label for="text-input" className="col-form-label">Address</label>
										...
										<div className="row">
											...
											<div className="col-xl-6 col-lg-6">
												<div className="form-group s-opt">
													<label for="State" className="col-form-label">State/Country</label>
										...
										<div className="form-group">
											<label for="password-input" className="col-form-label">Postal Code</label>
										...
										<div className="form-group mb-0">
											<button className="btn btn-primary squer-btn mt-2 mr-2" type="submit">Submit</button>
										</div>
                                    </form>
                                </div>
                            </div>
											...
											<div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
												<div className="ad-checkout-tab">
													...
													<div className="ad-radio-button">
														...
														<label for="radio-1" className="radio-label">Check Payments</label>
													</div>
													<div className="ad-radio-button">
														<input id="radio-2" name="radio" type="radio"/>
														<label  for="radio-2" className="radio-label">Cash On Delivery</label>
													</div>
													<div className="ad-radio-button">
													...
													<div className="ad-place-order">
														<button type="button" className="btn btn-primary squer-btn mt-2 mr-2">Place Order</button>
													</div>
												</div>
											</div>
											<div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
