...
const fetchProductsData = useCallback(
  async (
    ...
    //   }
      ...
      if (statuses.length > 0) params.status = statuses.join(','); // gửi dạng chuỗi phân cách bởi dấu phẩy
  ...
  []
	...
	useEffect(() => {
  fetchProductsData(0, 10, searchTerm, minPrice, maxPrice, selectedTags, selectedStatuses);
}, [searchTerm, minPrice, maxPrice, selectedTags, selectedStatuses]);
