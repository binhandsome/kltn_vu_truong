const Faq = () => (
    ...
    {/* <!--===Products Details===--> */}
    <div className="product-detail-wrapper product-detail-wrapper22">
        <div className="row">
                    ...
                    <div className="tab-content">
                        <div id="description" className="tab-pane fade show active">
                            <div className="int-tab-peragraph">
                                ...
                                <h4><span><i className="far fa-question-circle"></i></span> Why do we use it?</h4>
                                <p>Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary.</p>
                                <h4><span><i className="far fa-question-circle"></i></span> Where can I get some?</h4>
                                <p>To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental.</p>
