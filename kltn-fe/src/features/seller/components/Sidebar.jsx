    ...
    <ul className="main-menu">
      <li>
        ...
        <ul className="sub-menu">
          ...
          <li>
            {/* User */}
            <a href="/seller/dashboard/userDashboard">
              <span className="icon-dash"></span>
      ...
      <li>
        <a href="/seller/customer/customer">
          <span className="icon-menu feather-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
      ...
      <li>
        <a href="/seller/fontawasome/fontAwasome">
          <span className="icon-menu feather-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
      ...
      <li>
        ...
        <ul className="sub-menu">
          <li>
            {/* Progress Bars */}
            <a href="/seller/uikit/progressBars">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Accordation */}
            <a href="/seller/uikit/accordation">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Pagination */}
            <a href="/seller/uikit/pagination">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Typograpgy */}
            <a href="/seller/uikit/typography">
              <span className="icon-dash"></span>
      ...
      <li>
        ...
        <ul className="sub-menu">
          <li>
            {/* Basic Table */}
            <a href="/seller/table/basicTable">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Advance Table */}
            <a href="/seller/table/advanceTable">
              <span className="icon-dash"></span>
      ...
      <li>
        ...
        <ul className="sub-menu">
          ...
          <li>
            {/* Register */}
            <a href="/seller/authentication/register">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Recover Password */}
            <a href="/seller/authentication/recoverPassword">
              <span className="icon-dash"></span>
      ...
      <li className="active-li">
        ...
        <ul className="sub-menu show-submenu">
          ...
          <li>
            {/* Product Single */}
            <a href="/seller/general/productSingle">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Wishlist */}
            <a href="/seller/general/wishlist">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Checkout */}
            <a href="/seller/general/checkout">
              <span className="icon-dash"></span>
          ...
          <li>
            {/* Error 404 */}
            <a href="/seller/general/error404">
              <span className="icon-dash"></span>
      ...
      <li>
        <a href="/seller/documentation/documentation">
          <span className="icon-menu feather-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
