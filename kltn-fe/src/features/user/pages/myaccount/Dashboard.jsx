			...
			<div className="container">
                <div className="row">
					<aside className="col-xl-3">
						<div className="toggle-info">
							<h5 className="title mb-0">Account Navbar</h5>
							<a className="toggle-btn" href="account-dashboard.html#accountSidebar">Account Menu</a>
						</div>
						<div className="sticky-top account-sidebar-wrapper">
							<div className="account-sidebar" id="accountSidebar">
								<div className="profile-head">
                    ...
                    <section className="col-xl-9 account-wrapper">
						<div className="account-card">
							<div className="m-b30">
								<p>Hello <strong className="text-black">John Doe</strong> (not <strong className="text-black">John Doe</strong>? <a href="/auth/login" className="text-underline">Log out</a>)</p>
								<p>From your account dashboard you can view your <a href="account-orders.html" className="text-underline">recent orders</a>, manage your <a href="account-address.html" className="text-underline">shipping and billing addresses</a>, and <a href="account-profile.html" className="text-underline">edit your password and account details</a>.</p>
							</div>
							<div className="row g-4">
								<div className="col-md-4">
									<div className="total-contain">
