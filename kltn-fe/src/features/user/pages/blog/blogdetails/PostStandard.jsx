...
như Aldus PageMaker bao gồm các phiên bản của Lorem Ipsum.
                ...
                <figure className="wp-container-5 wp-block-gallery-3 wp-block-gallery has-nested-images columns-3 is-cropped">
                  <figure className="wp-block-image size-large">
                    <img src="../../../assets/user/images/blog/blogpost-3/pic1.jpg" alt="/" />
                  </figure>
                  <figure className="wp-block-image size-large">
                    <img src="../../../assets/user/images/blog/blogpost-3/pic2.jpg" alt="/" />
                  </figure>
                  <figure className="wp-block-image size-large">
                    <img src="../../../assets/user/images/blog/blogpost-3/pic3.jpg" alt="/" />
                  </figure>
                  <figure className="wp-block-image size-large">
                    <img src="../../../assets/user/images/blog/blogpost-3/pic4.jpg" alt="/" />
                  </figure>
                  <figure className="wp-block-image size-large">
                    <img src="../../../assets/user/images/blog/blogpost-3/pic1.jpg" alt="/" />
                  </figure>
              ...
              <div className="col-lg-6 col-md-6 m-b30">
                <div className="dz-card style-5">
                  ...
                  <div className="dz-info">
                    <div className="dz-meta">
                      <ul>
                        <li className="post-date">20 Apr 2024</li>
                      </ul>
                    </div>
              ...
              <div className="col-lg-6 col-md-6 m-b30">
                <div className="dz-card style-5">
                  ...
                  <div className="dz-info">
                    <div className="dz-meta">
                      <ul>
                        <li className="post-date">10 June 2024</li>
                      </ul>
                    </div>
                    <h4 className="dz-title">
                      <a href="blog-grid-right-sidebar.html">
                        Runway Rundown: Decoding Fashion Week’s Best Looks
                      </a>
                    </h4>
                    <a
                      href="blog-grid-right-sidebar.html"
                ...
                <ol className="comment-list">
                    ...
                    <ol className="children">
                      ...
                      >
                        <div className="comment-body" id="div-comment-3">
                          <div className="comment-author vcard">
                            <img
                              src="../../../assets/user/images/profile3.jpg"
                              alt="/"
                              className="avatar"
                            />
                  ...
                  >
                    <div className="comment-body" id="div-comment-4">
                      <div className="comment-author vcard">
                        <img
                          src="../../../assets/user/images/profile2.jpg"
                          alt="/"
                          className="avatar"
                        />
            ...
            <div className="widget recent-posts-entry">
              ...
              <div className="widget-post-bx">
                <div className="widget-post clearfix">
                  <div className="dz-media">
                    <a href="post-standard.html">
                      <img src="../../../assets/user/images/blog/recent-blog/pic1.jpg" alt="/" />
                    </a>
                  </div>
                  <div className="dz-info">
                    <div className="dz-meta">
                ...
                <div className="widget-post clearfix">
                  <div className="dz-media">
                    <a href="post-standard.html">
                      <img src="../../../assets/user/images/blog/recent-blog/pic2.jpg" alt="/" />
                    </a>
                  </div>
                  <div className="dz-info">
                    <div className="dz-meta">
                    ...
                    <h6 className="title">
                      <a href="post-standard.html">
                        Shopping Cart Design User-Friendly Tips and Best
                        Practices
                      </a>
                    </h6>
                  </div>
                ...
                <div className="widget-post clearfix">
                  <div className="dz-media">
                    <a href="post-standard.html">
                      <img src="../../../assets/user/images/blog/recent-blog/pic3.jpg" alt="/" />
                    </a>
                  </div>
                  <div className="dz-info">
                    <div className="dz-meta">
                    ...
                    <h6 className="title">
                      <a href="post-standard.html">
                        Shopping Cart Security Keeping Your Customers' Data Safe
                      </a>
                    </h6>
                  </div>
                </div>
