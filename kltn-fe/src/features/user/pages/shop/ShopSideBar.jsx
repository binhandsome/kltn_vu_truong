              ...
              <div className="shop-tab">
                <ul className="nav" role="tablist" id="dz-shop-tab">
                  <li className="nav-item" role="presentation">
                    <a
                      href="shop-sidebar.html#tab-list-list"
                  ...
                  <li className="nav-item" role="presentation">
                    <a
                      href="shop-sidebar.html#tab-list-column"
                      className="nav-link"
                  ...
                  <li className="nav-item" role="presentation">
                    <a
                      href="shop-sidebar.html#tab-list-grid"
                      className="nav-link"
                      ...
                      <div className="dz-content">
                        <div className="dz-header">
                          ...
                          <div className="review-num">
                            ...
                            <span>
                              <a href="javascript:void(0);"> 370 Review</a>
                            </span>
                          </div>
                        </div>
                              ...
                              <div className="meta-content">
                                ...
                                <div className="d-flex align-items-center color-filter">
                                  ...
                                  <div className="form-check">
                                    ...
                                    <span
                                      style={{
                                        backgroundColor: "rgb(140, 178, 209)"
                                      }}
                                    />
                                  </div>
                                  <div className="form-check">
                      ...
                      <div className="dz-content">
                        <div className="dz-header">
                          ...
                          <div className="review-num">
                            ...
                            <span>
                              <a href="javascript:void(0);"> 455 Review</a>
                            </span>
                          </div>
                        </div>
                        <div className="dz-body">
