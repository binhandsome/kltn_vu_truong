              ...
              <div className="shop-tab">
                <ul className="nav" role="tablist" id="dz-shop-tab">
                  <li className="nav-item" role="presentation">
                    <a
                      href="shop-filters-top-bar.html#tab-list-list"
                  ...
                  <li className="nav-item" role="presentation">
                    <a
                      href="shop-filters-top-bar.html#tab-list-column"
                      className="nav-link"
              ...
              >
                <div className="row">
                  <div className="col-lg-6 m-b30">
                    <div className="shop-card style-1">
                      <div className="dz-media">
                        <img src="../../assets/user/images/shop/large/1.png" alt="image" />
                        <div className="shop-meta">
                          <a
                            href="javascript:void(0);"
                            className="btn btn-secondary btn-md btn-rounded"
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 m-b30">
                    <div className="shop-card style-1">
                      <div className="dz-media">
                        <img src="../../assets/user/images/shop/large/2.png" alt="image" />
                        <div className="shop-meta">
                          <a
                            href="javascript:void(0);"
                            className="btn btn-secondary btn-md btn-rounded"
...
export default ShopFiltersTopBar;