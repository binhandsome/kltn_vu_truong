  ...
  <div className="dz-bnr-inr bg-secondary">
    <div className="container">
      <div className="dz-bnr-inr-entry text-start">
        <h1>
          Make your fashion look <br /> mire charming
        </h1>
              ...
              <div className="dz-box portfolio-bx style-1">
                <div className="dz-media rounded">
                  <a
                    ...
                    href="../../assets/user/images/portfolio/details/portfolio-detail-1/pic1.jpg"
                    data-src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic1.jpg"
                  >
                    <i className="feather icon-maximize dz-maximize top-right" />
                  </a>
                  <img
                    src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic1.jpg"
                    alt="image"
                  />
                </div>
              </div>
            ...
            <div className="col-xl-6 col-md-6 col-6 m-b30">
              <div className="dz-box portfolio-bx style-1">
                <div className="dz-media rounded">
                  <a
                    className="mfp-link lg-item"
                    href="../../assets/user/images/portfolio/details/portfolio-detail-1/pic2.jpg"
                    data-src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic2.jpg"
                  >
                    <i className="feather icon-maximize dz-maximize top-right" />
                  </a>
                  <img
                    src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic2.jpg"
                    alt="image"
                  />
                </div>
              </div>
            ...
            <div className="col-xl-6 col-md-6 col-6 m-b30">
              <div className="dz-box portfolio-bx style-1">
                <div className="dz-media rounded">
                  <a
                    className="mfp-link lg-item"
                    href="../../assets/user/images/portfolio/details/portfolio-detail-1/pic3.jpg"
                    data-src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic3.jpg"
                  >
                    <i className="feather icon-maximize dz-maximize top-right" />
                  </a>
                  <img
                    src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic3.jpg"
                    alt="image"
                  />
                </div>
              </div>
            ...
            <div className="col-xl-6 col-md-6 col-6 m-b30">
              <div className="dz-box portfolio-bx style-1">
                <div className="dz-media rounded">
                  <a
                    className="mfp-link lg-item"
                    href="../../assets/user/images/portfolio/details/portfolio-detail-1/pic4.jpg"
                    data-src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic4.jpg"
                  >
                    <i className="feather icon-maximize dz-maximize top-right" />
                  </a>
                  <img
                    src="../../assets/user/images/portfolio/details/portfolio-detail-1/pic4.jpg"
                    alt="image"
                  />
                </div>
              </div>
          ...
          <div className="post-prev">
            <a href="portfolio-details-5.html" className="post-inner">
              ...
              <div className="dz-media me-3">
                <img
                  src="../../assets/user/images/portfolio/details/portfolio-detail-1/post-pagination/post-1.jpg"
                  alt=""
                />
              </div>
          ...
          <div className="post-next">
            <a href="portfolio-details-2.html" className="post-inner">
              ...
              <div className="dz-media">
                <img
                  src="../../assets/user/images/portfolio/details/portfolio-detail-1/post-pagination/post-2.jpg"
                  alt=""
                />
              </div>
              <div className="inner-icon">
              ...
              <div className="portfolio-box">
                <div className="dz-media">
                  <a href="portfolio-details-1.html">
                    <img
                      src="../../assets/user/images/portfolio/details/portfolio-detail-1/related-img/pic1.jpg"
                      alt="/"
                    />
                  </a>
                </div>
            ...
            <div className="swiper-slide">
              <div className="portfolio-box">
                <div className="dz-media">
                  <a href="portfolio-details-1.html">
                    <img
                      src="../../assets/user/images/portfolio/details/portfolio-detail-1/related-img/pic2.jpg"
                      alt="/"
                    />
                  </a>
                </div>
            ...
            <div className="swiper-slide">
              <div className="portfolio-box">
                <div className="dz-media">
                  <a href="portfolio-details-1.html">
                    <img
                      src="../../assets/user/images/portfolio/details/portfolio-detail-1/related-img/pic3.jpg"
                      alt="/"
                    />
                  </a>
                </div>
            ...
            <div className="swiper-slide">
              <div className="portfolio-box">
                <div className="dz-media">
                  <a href="portfolio-details-1.html">
                    <img
                      src="../../assets/user/images/portfolio/details/portfolio-detail-1/related-img/pic4.jpg"
                      alt="/"
                    />
                  </a>
                </div>
