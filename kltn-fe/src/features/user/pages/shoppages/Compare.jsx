          ...
          <tbody>
            <tr className="compare-product">
              ...
              <td>
                <div className="shop-card style-8">
                  ...
                  <div className="dz-content">
                    <h5 className="title">
                      <a href="javascript:void(0);">Flawless Denim Delights</a>
                    </h5>
              ...
              <td>
                <div className="shop-card style-8">
                  <div className="dz-media">
                    <img src="../../assets/user/images/upload.png" alt="image" />
                  </div>
                  <div className="dz-content">
                    <h5 className="title">
    ...
    <div className="container">
      <div className="section-inner">
        ...
        <div className="row gx-3 companies-inner">
          <div
            className="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp"
            data-wow-delay="0.1s"
          >
