  ...
  return (
    <>
      <div className="page-wraper">
		...
		{/* <!--Banner Start--> */}
		<div class="dz-bnr-inr bg-light" style={{ backgroundImage: `url('../assets/user/images/background/bg1.jpg')` }}>
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="section-head wow fadeInUp m-md-r100" data-wow-delay="0.1s">
							<h2 class="title">Pixio Your Style, Quality, Individuality - Redefining Fashion Together.	</h2>
						...
						<div class="author-bx-detail m-b40 wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="accordion dz-accordion accordion-sm wow fadeInUp m-b50" data-wow-delay="0.3s" id="accordionFaq">
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingOne">
									<a href="about-me.html#" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingTwo">
									<a href="about-me.html#" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingThree">
									<a href="about-me.html#" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingFour">
									<a href="about-me.html#" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingFive">
									<a href="about-me.html#" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
						...
						<div class="about-sale">
							<div class="row">
								<div class="col-lg-5 col-md-6 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.4s">
									<div class="about-content">
										<h2 class="title"><span class="counter">50</span>+</h2>
										<p class="text">Items Sale</p>
									</div>
								</div>
								<div class="col-lg-5 col-md-6 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.5s">
									<div class="about-content">
						...
						<div class="row g-xl-4 g-md-4 g-3">
							<div class="col-xl-8 col-lg-8 col-sm-8 col-8 wow fadeInUp" data-wow-delay="0.4s">
								<div class="about-thumb">
									<img src="/assets/user/images/about/pic4.jpg" alt="" class="rounded" />
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-sm-4 col-4 wow fadeInUp" data-wow-delay="0.5s">
								<div class="about-thumb">
									<img src="/assets/user/images/about/pic5.jpg" alt="" class="rounded" />
								</div>
							</div>
							<div class="col-lg-12 wow fadeInUp" data-wow-delay="0.6s">
								<div class="about-thumb">
									<img src="/assets/user/images/about/pic6.jpg" alt="" class="rounded" /> 
								</div>
							</div>
							<div class="col-lg-12 wow fadeInUp" data-wow-delay="0.7s">
								<div class="about-thumb">
									<img src="/assets/user/images/about/pic7.jpg" alt="" class="rounded" />
								</div>
							</div>
						</div>
					</div>		
				...
				<div class="row  align-items-center ">
					<div class="col-lg-6 order-lg-1 order-2">
						<div class="side-content">
							<div class="about-thumb">
								<img src="/assets/user/images/girl.png" alt="" />
							</div>
							<div class="our-customer wow fadeInUp" data-wow-delay="0.2s" style={{
  visibility: 'visible',
  animationDelay: '0.2s',
  animationName: 'fadeInUp'
								...
								<ul>
									<li class="customer-image">
										<img src="/assets/user/images/testimonial/pic1.png" alt=""   />
									</li>
									<li class="customer-image">
										<img src="/assets/user/images/testimonial/pic2.png" alt="" />
									</li>
			...
			<img src="/assets/user/images/line-shap.png" alt="" class="line"/> 
		</section>
		{/* <!-- About End --> */}
		
		{/* <!-- Companies --> */}
		<section class="content-inner-1 companies bg-light ">
			<div class="container">
				<div class="section-inner">
					<div class="section-head style-3 wow fadeInUp" data-wow-delay="0.1s">
