...
public interface DeliveryInfoRepository extends JpaRepository<DeliveryInfo, Long> {
    ...
    List<DeliveryInfo> findByOrderIdIn(@Param("storeId") Long storeId, @Param("orderIds") List<Long> orderIds);
    ...
    @Query("SELECT di FROM DeliveryInfo di WHERE di.orderId IN :orderIds")
    List<DeliveryInfo> findByOrderIdIn(@Param("orderIds") List<Long> orderIds);
